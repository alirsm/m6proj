...
function create_resetRejectMailMessage($fromEmail, $toEmail) 
{	
	$head = <<<HEAD
<!doctype html>
<html lang="en">
...
HEAD;
	...
	echo "Attention User,<br><br>Your password reset request has been <a class='underline' href='#'><span class='redText'>REJECTED</span></a> by your company admin.<br><br>";
...
// example to call
//create_resetRejectMailMessage("admin@cloud.microv.net", "user@gmail.com");
