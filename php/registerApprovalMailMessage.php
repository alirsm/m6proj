...
function create_registerApprovalMailMessage($fromEmail, $toEmail, $subject, $userName, $userEmail, $userPhone, $userExt, $userPassword) 
{	
	$head = <<<HEAD
<!doctype html>
<html lang="en">
...
HEAD;
	...
	echo "<h4>Web Portal Registration Approval</h4></td></tr></table>";
	...
	echo "Your extension registration request has been approved by your company admin. Please use the following temporary password to login to your account..<br><br>";
...
/*
create_registerApprovalMailMessage("wwebportaladmin@microv.net",
												 "alirsm@gmail.com",
												 "HTML email",
												 "John Smitj",
